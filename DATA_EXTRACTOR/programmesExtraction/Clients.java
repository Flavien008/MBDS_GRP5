...
public class Clients {
    ...
    public void initClientsTables(Clients arb) {
        arb.dropTableClients();
        arb.createTableClients();
        arb.loadClientsFromCSV("/vagrant/MBDS_GRP5/DATA_EXTRACTOR/dataSources/Clients_4.csv");
        arb.loadClientsFromCSV("/vagrant/MBDS_GRP5/DATA_EXTRACTOR/dataSources/Clients_15.csv");
    ...
    public void loadClientsFromCSV(String clientDataFileName) {
        String line;
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(clientDataFileName))) {
            while ((line = br.readLine()) != null) {
                ...
                // voir si "N/D" ou "?" ou " ", si oui, passer au suivan
                ...
                this.insertClientRow(id, age, sexe, taux, SFamiliale, nbEnfantsAcharge, voiture_2, immatriculation);
                id++;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void insertClientRow(int clientid, int age, String sexe, int taux, String SFamiliale, int nbEnfantsAcharge,
